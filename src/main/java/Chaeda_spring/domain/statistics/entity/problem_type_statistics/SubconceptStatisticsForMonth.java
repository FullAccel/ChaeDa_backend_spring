...
public class SubconceptStatisticsForMonth implements Statistics {
    ...
    @Builder
    public SubconceptStatisticsForMonth(MathProblemType type, Student student, LocalDate targetMonth, Long solvedNum, Long wrongNum, Long easyNum, Long middleNum, Long hardNum) {
        this.type = type;
